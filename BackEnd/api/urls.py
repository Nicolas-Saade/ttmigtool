...
from .views import upload_json_file, get_profile_mappings, create_user_profile, check_email, creator_data  # Added endpoint
...
urlpatterns = [
        ...
        path('creator-data/', creator_data, name='creator_data'),  # Added endpoint
]